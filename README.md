...
This can easily be achieved for each library using the tximport R package.  
...
<b>input : </b> annotation, abundances files generated by kallisto  
<b>output : </b> abundance at gene level  
<b>command line : </b>  
```
R CMD BATCH --no-save --no-restore '--args annotation_file_path="path/to/custom_annotation.gtf" abundance_kallisto_file_path="path/to/abundance.tsv" abundance_gene_level_dir_path="path/to/output/dir"' summarize_gene_level.R summarize_gene_level.Rout
```
